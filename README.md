# Home Assistant Addon: RomM

Repository di addon personalizzati per Home Assistant.
...
**Funzionalità:**
- Supporto SQLite (zero dipendenze) o MariaDB
- Scraping automatico di copertine e metadati (IGDB, ScreenScraper)
- Player web integrato (EmulatorJS) per giocare nel browser
- Supporto per decine di piattaforme retro

## Come aggiungere il repository
